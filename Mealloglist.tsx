        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            {meal.sourceType === 'estimate' && (
              <span className="shrink-0 text-[10px] px-1.5 py-0.5 rounded-md bg-amber-500/15 text-amber-400 font-semibold border border-amber-500/20">
                EST
              </span>
            )}
          </div>
          ...
          {meal.servingDescription && (
            <p className="text-xs text-gray-600 mb-2">{meal.servingDescription}</p>
          )}
          {/* Macro pills */}
        ...
        <div className="flex items-start gap-3 shrink-0">
          ...
          {onDelete && (
            <button
              ...
              className="opacity-0 group-hover:opacity-100 transition-opacity p-1 -mr-1 text-gray-600 hover:text-rose-400"
            >
